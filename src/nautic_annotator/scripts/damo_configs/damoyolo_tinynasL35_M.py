...
class Config(MyConfig):
    def __init__(self):
        ...
        package_path = rospack.get_path('nautic_annotator')  # replace with your package name
        ckpt_path = os.path.join(package_path, 'scripts/damo/base_models/backbones/nas_backbones/tinynas_L35_kxkx.txt')
        structure = self.read_structure(ckpt_path)
